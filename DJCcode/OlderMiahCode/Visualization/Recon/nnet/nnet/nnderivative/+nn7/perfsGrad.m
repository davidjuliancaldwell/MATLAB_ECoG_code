...
[Y,trainPerf,trainN,gWB] = calc_Y_trainPerfGrad(net,data,hints,hints.direction);
...
% FROM NNTRAINING.PERFS_GRAD
function [Y,trainPerf,trainN,gWBy] = calc_Y_trainPerfGrad(net,data,hints,direction)
