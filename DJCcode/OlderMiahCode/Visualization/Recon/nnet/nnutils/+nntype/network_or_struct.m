function [out1,out2] = network_or_struct(in1,in2,in3)
%NN_NETWORK_OR_STRUCT Neural Network object or structure type.
...
function err = type_check(x)
  if ~isa(x,'network') && ~isstruct(x)
    err = 'VALUE is not a neural network object or structure.';
  elseif isempty(x)
