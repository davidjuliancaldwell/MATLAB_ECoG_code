function [out1,out2] = strict_pos_inf_scalar(in1,in2,in3)
%NN_STRICT_POS_INF_SCALAR Strictly positive or infinite scalar.
...
function info = get_info
  info = nnfcnType(mfilename,'Strictly Positive or Infinite Scalar',7.0);
end
