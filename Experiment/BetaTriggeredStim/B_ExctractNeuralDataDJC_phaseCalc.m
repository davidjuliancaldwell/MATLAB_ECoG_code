...
for idx = 2:9
    ...
    for chan = chans
        ...
        save(fullfile(OUTPUT_DIR, [sid '_' num2str(chan) '_phaseDelivery.mat']), 'sid','t','r_square','r_square_acaus','r_square_caus','r_square_neg_acaus','r_square_pos','r_square_neg','r_square_neg_caus',...
