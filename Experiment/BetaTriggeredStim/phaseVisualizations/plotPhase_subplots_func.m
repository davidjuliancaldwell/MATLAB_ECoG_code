function [] = plotPhase_subplots_func(t,fitline,f,phase,r_square,desiredF,sid,subjectNum,chan,type,signalType,OUTPUT_DIR,saveIt)

figure
subplot(2,1,1)
plot(1e3*t,fitline)
hold on
plot(1e3*t,mean(fitline,2),'k','linewidth',4)
