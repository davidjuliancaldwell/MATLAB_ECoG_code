...
Z_ConstantsBrocas;
addpath('../BetaTriggeredStim/scripts')
...
if (strcmp(sid, '0b5a2e'))
    tank = TTank;
    tp = strcat(SUB_DIR,'\0b5a2e\data\d8\0b5a2e_otherStim\0b5a2e_otherStim');
    tank.openTank(tp)
...
save(fullfile(META_DIR, [sid '_BROCAS_StimulationAndCCEPs.mat']), 't','ECoGData','ECoGDataAverage','-v7.3');
