...
load(fullfile(getSubjDir(sid), 'trodes.mat'));
...
windowSize = round(8 * fs); %sliding window will be 10 second long segments
numChans = 64;
...
figure
clims = [-1 1];
imagesc(masked_beta_plvdiff2,clims)
colorbar
title(['Subject ' sid ' Difference from Post to Pre Resting State Beta PLV After Stimulation']);
