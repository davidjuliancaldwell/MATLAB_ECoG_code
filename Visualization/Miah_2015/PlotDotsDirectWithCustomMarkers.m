function PlotDotsDirectWithCustomMarkers(subject, trodeLocations, weights, viewSide, clims, markerSize, markerIndicator, colormapName, trodeLabels, plotLabels, doAsOverlay)
