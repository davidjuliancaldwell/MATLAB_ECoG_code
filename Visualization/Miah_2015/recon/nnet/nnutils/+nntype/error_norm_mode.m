function [out1,out2] = error_norm_mode(in1,in2,in3)
%NN_ERROR_MODE Error mode.
%
...
% TODO - change "normalized" to "standard"
...
function err = type_check(x)
  ...
  elseif isempty(nnstring.first_match(lower(x),{'','none','standard','percent'}))
    err = 'VALUE is not ''none'', ''standard'' or ''percent''.';
  else
    err = '';
  end
end
