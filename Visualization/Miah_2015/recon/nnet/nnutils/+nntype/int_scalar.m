function [out1,out2] = int_scalar(in1,in2,in3)
%NN_POS_INT_SCALAR Positive integer scalar type.
%
%  This function defines the type: Positive integer scalar.
%
...
function info = get_info
  info = nnfcnType(mfilename,'Integer',7.0);
end
