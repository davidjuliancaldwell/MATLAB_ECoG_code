function [out1,out2] = pos_scalar(in1,in2,in3)
%NN_POS_SCALAR Positive scalar.
...
function info = get_info
  info = nnfcnType(mfilename,function_name,7,examples);
end

function name = function_name, name = 'Positive Scalar'; end

function x = examples
  x = {0 0.5 1 exp(1) pi 5 10 15.6 20};
end
