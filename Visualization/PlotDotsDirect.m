function PlotDotsDirect(subject, trodeLocations, weights, viewSide, clims, markerSize, colormapName, trodeLabels, plotLabels, doAsOverlay,alpha)
...
% DJC 3-27-2017 - edit for alpha to see internal electrodes if of interest 
if (~exist('doAsOverlay', 'var') || doAsOverlay == false)
    if (~exist('alpha','var'))
        PlotCortex(subject, viewSide);
    else
        PlotCortex(subject, viewSide,[],alpha);
    end
end
