...
% $Revision: 1.1.6.20 $ $Date: 2012/04/20 19:14:10 $
...
function net = formatNet(net)
  if isempty(net.performFcn)
    warning('nnet:traincgf:Performance',nnwarn_empty_performfcn_corrected);
    net.performFcn = 'mse';
  end
end
...
function [calcNet,tr] = train_network(archNet,rawData,calcLib,calcNet,tr)
  ...
  for epoch=0:param.epochs
      if isMainWorker
        ...
        if userStop, tr.stop = 'User stop.'; calcNet = best_net;
