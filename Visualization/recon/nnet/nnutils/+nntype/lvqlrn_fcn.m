function [out1,out2] = lvqlrn_fcn(in1,in2,in3)
%NNTYPE_LVQLRN_FCN LVQ learning functions
%
...
function err = type_check(x)
  ...
  elseif isempty(nnstring.first_match(lower(x),{'learnlv1','learnlv2'}))
    err = 'VALUE is not ''learnlv1'' or ''learnlv2''.';
  else
    err = '';
  end
end
