function [out1,out2] = pos_inf_scalar(in1,in2,in3)
%NN_POS_INF_SCALAR Positive or infinite scalar.
...
function info = get_info
  info = nnfcnType(mfilename,'Positive or Infinite Scalar',7.0);
end
