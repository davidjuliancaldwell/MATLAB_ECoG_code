function [out1,out2] = strict_pos_int_row(in1,in2,in3)
%NN_STRICT_POS_INT_ROW Strictly positive integer row vector.
...
function info = get_info
  info = nnfcnType(mfilename,'Strictly Positive Integer Row Vector',7.0);
end
