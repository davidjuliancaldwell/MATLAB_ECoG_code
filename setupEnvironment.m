...
if ispc
    setenv('matlab_devel_dir', 'C:\Users\david\SharedCode\MATLAB_ECoG_Code');
    setenv('gridlab_dir', 'C:\Users\david\SharedCode\MATLAB_ECoG_Code');
    setenv('shared_code_dir', 'C:\Users\david\SharedCode');
    setenv('subject_dir', 'C:\Users\david\Data\Subjects');
    setenv('dbs_subject_dir','G:\My Drive\GRIDLabDavidShared\DBS\');
    setenv('OUTPUT_DIR', 'C:\Users\david\Data\Output');
